# Generated by Powerlevel10k configuration wizard on 2019-08-18 at 14:18 MDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL='\UE0BA'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_BACKGROUND=48
  ...
  #
    ...
    typeset -g POWERLEVEL9K_DIR_CLASSES=(
        '/mnt/c/Users/ryola/Documents/GitHub(/*)#' WORK '\ue708'
        '~(/*)#'       HOME     '%F\uf824'
        '*'            DEFAULT  '')
  ...
  vcs+='${${VCS_STATUS_LOCAL_BRANCH:+%231F'${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}'${VCS_STATUS_LOCAL_BRANCH//\%/%%}}'
  vcs+=':-%f@%28F${VCS_STATUS_COMMIT[1,8]}}'
  # ':master' if the tracking branch name differs from local branch.
  vcs+='${${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH}:+%f:%28F${VCS_STATUS_REMOTE_BRANCH//\%/%%}}'
  # '#tag' if on a tag.
  vcs+='${VCS_STATUS_TAG:+%f#%28F${VCS_STATUS_TAG//\%/%%}}'
  # ⇣42 if behind the remote.
  vcs+='${${VCS_STATUS_COMMITS_BEHIND:#0}:+ %28F⇣${VCS_STATUS_COMMITS_BEHIND}}'
  # ⇡42 if ahead of the remote; no leading space if also behind the remote: ⇣42⇡42.
  # If you want '⇣42 ⇡42' instead, replace '${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }' with ' '.
  vcs+='${${VCS_STATUS_COMMITS_AHEAD:#0}:+${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }%28F⇡${VCS_STATUS_COMMITS_AHEAD}}'
  # *42 if have stashes.
  vcs+='${${VCS_STATUS_STASHES:#0}:+ %28F*${VCS_STATUS_STASHES}}'
  ...
  vcs+='${${VCS_STATUS_NUM_STAGED:#0}:+ %92F+${VCS_STATUS_NUM_STAGED}}'
  # !42 if have unstaged changes.
  vcs+='${${VCS_STATUS_NUM_UNSTAGED:#0}:+ %92F!${VCS_STATUS_NUM_UNSTAGED}}'
...
typeset -g POWERLEVEL9K_STATUS_BACKGROUND=239
...
typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="❱ "
typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_BACKGROUND=
typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX=" %F{014}\u2570%F{cyan}\uF460%F{073}\uF460%F{109}\uF460"
...
typeset -g POWERLEVEL9K_NODEENV_PROMPT_ALWAYS_SHOW=true
typeset -g POWERLEVEL9K_NVM_PROMPT_ALWAYS_SHOW=true
typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status time load nodeenv nvm)

# typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_middle
# typeset -g POWERLEVEL9K_SHORTEN_DIR_LENGTH=1

typeset -g POWERLEVEL9K_TIME_FORMAT="%D{\uf017 %I:%M%P \uf073 %a %b %d,%Y}"
typeset -g POWERLEVEL9K_TIME_ICON=""
typeset -g POWERLEVEL9K_TIME_BACKGROUND='white'
typeset -g POWERLEVEL9K_RAM_BACKGROUND='yellow'
typeset -g POWERLEVEL9K_LOAD_CRITICAL_BACKGROUND="white"
typeset -g POWERLEVEL9K_LOAD_WARNING_BACKGROUND="white"
